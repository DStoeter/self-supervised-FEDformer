...
def main():
    ...
    parser.add_argument('--task_id', type=str, default='Illness_RandMask20_predLen60', help='task id')
    ...
    print(args)
    print("Pre-Training is", pre_train)

    Exp = Exp_Main

    encoder_loss_iteration = 9

    if args.is_training:
        # for eni in range(encoder_loss_iteration):
        #     # if eni == 0 or eni == 1 or eni == 2 or eni == 3 or eni == 4:
        #     # if eni == 0:
        #         break

        for ii in range(args.itr):
            # setting record of experiments
            # eni after mode_select!!!
